                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="position" id="" class="form-control form-control-sm"
                                        id="status">
                                        <option value="0" @if (old('position') == 0) selected @endif>اصلی
                                        </option>
                                        <option value="1" @if (old('position') == 1) selected @endif>کنار بالا
                                        </option>
                                        <option value="2" @if (old('position') == 1) selected @endif>کنار پایین
                                        </option>
                                    </select>
                                </div>
                                @error('position')
