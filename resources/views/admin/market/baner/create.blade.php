    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.market.baner.store') }}" id="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="position" id="" class="form-control form-control-sm"
                                        id="status">
                                        <option value="0" @if (old('position') == 0) selected @endif> اسلاید
                                        </option>
                                        <option value="1" @if (old('position') == 1) selected @endif> کنار بالا (اصلی) 
                                        </option>
                                        <option value="2" @if (old('position') == 2) selected @endif> کنار پایین (اصلی) 
                                        </option>
                                        <option value="3" @if (old('position') == 3) selected @endif>  وسط (اصلی)   
                                        </option>
                                        <option value="4" @if (old('position') == 4) selected @endif> پایین (اصلی)
                                        </option>
                                    </select>
                                </div>
                                @error('position')
