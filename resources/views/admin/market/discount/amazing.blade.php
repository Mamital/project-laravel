                            ...
                            @foreach ($discounts as $discount)
                                <tr>
                                    ...
                                    <td class="width-16-rem text-left">
                                        <a href="{{route('admin.market.discount.amazingSale.edit', $discount->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>
                                            ویرایش</a>
                                        <form class="d-inline"
                                            action="{{ route('admin.market.discount.amazingSale.destroy', $discount->id) }}"
                                            method="post">
                                            @csrf
                                            {{ method_field('delete') }}
