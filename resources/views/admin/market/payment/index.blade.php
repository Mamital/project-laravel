                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="width-22-rem text-left">
                                ...
                                <a href="{{route('admin.market.payment.cancel', $payment->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-close"></i> باطل کردن</a>
                                <a href="{{route('admin.market.payment.return', $payment->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-reply"></i> برگرداندن</a>
                            </td>
                        </tr>
                        @endforeach          
                    </tbody>
