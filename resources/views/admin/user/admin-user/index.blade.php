                            ...
                            @foreach ($admins as $key => $admin)
                                <tr>
                                    ...
                                    <td class="width-22-rem text-left">
                                        <a href="{{ route('admin.user.admin-user.role', $admin) }}"
                                            class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> نقش</a>
                                        <a href="{{ route('admin.user.admin-user.permission', $admin) }}"
                                            class="btn btn-info btn-sm"><i class="fa fa-check"></i> دسترسی</a>
