                                ...
                                <form class="row" method="post" action="{{ route('home.profile.my-profile.update') }}">
                                    ...
                                    <section class="col-6 mb-2">
                                        <label for="first_name" class="form-label mb-1">نام
                                            گیرنده</label>
                                        <input value="{{ $user->first_name ?? $user->first_name }}" type="text"
                                            name="first_name" class="form-control form-control-sm" id="first_name"
                                            placeholder="نام">
                                    </section>
                                    ...
                                    <section class="col-6 mb-2">
                                        ...
                                        <input value="{{ $user->last_name ?? $user->last_name }}" type="text"
                                            name="last_name" class="form-control form-control-sm" id="last_name"
                                    ...
                                    <section class="col-6 mb-2">
                                        ...
                                        <input value="{{ $user->national_code ?? $user->national_code }}" type="text"
                                            name="national_code" class="form-control form-control-sm" id="national_code"
                                            placeholder="کد ملی">
                                    </section>
