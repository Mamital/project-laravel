...
@section('content')
    <section class="vh-100 d-flex justify-content-center align-items-center pb-5">
        <form action="{{ route('home.profile.my-number.confirm', ['token' => $token]) }}" method="POST">
            @csrf
            <section class="login-wrapper mb-5">
                ...
                <section class="login-title">تایید شماره موبایل</section>
                <section class="login-info">پیامک ارسال شده به شماره {{ $mobile }} را وارد کنید</section>
                ...
                <a class="text-decoration-none" href="{{ route('home.profile.my-number.index') }}">شماره را اشتباهی وارد
                    کردید؟</a>
            </section>
    </section>
    </form>
