                ...
                @foreach ($addresses as $address)
                    ...
                    <!--checked="checked"-->
                        <label for="{{ $address->id }}" class="address-wrapper mb-2 p-2">
                            ...
                            <a data-bs-toggle="modal" data-bs-target="#edit-address-{{ $address->id }}"><i
                            ...
                            <section class="modal-dialog">
                                <section class="modal-content">
                                    ...
                                    <section class="modal-body">
                                        <form action='{{ route('home.sales-proccess.update-address', $address) }}'
                                            ...
                                            <section class="col-12 mb-2">
                                                <section class="form-check">
                                                    <input name="receiver" class="form-check-input" type="checkbox"
                                                        id="receiver" @if ($address->recipient_first_name) checked @endif>
                    ...
                    <section class="modal fade" id="add-address" tabindex="-1" aria-labelledby="add-address-label"
                        ...
                        <section class="modal-dialog">
                            <section class="modal-content">
                                ...
                                <section class="modal-body">
                                    <form action='{{ route('home.sales-proccess.add-address') }}' method="POST"
                                        class="row">
                                        @csrf
                                        <section class="col-6 mb-2">
                                            <label for="province" class="form-label mb-1">استان</label>
