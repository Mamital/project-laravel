                    ...
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
                        ...
                        <section class="sidebar-nav">
                            <section class="sidebar-nav-item">
                                <span class="sidebar-nav-item-title"><a class="p-3" href="{{route('home.profile.my-order')}}">سفارش های من</a></span>
                            </section>
                            <section class="sidebar-nav-item">
                                <span class="sidebar-nav-item-title"><a class="p-3" href="{{route('home.profile.my-address')}}">آدرس های من</a></span>
                            </section>
                            <section class="sidebar-nav-item">
                            ...
                            <section class="sidebar-nav-item">
                                <span class="sidebar-nav-item-title"><a class="p-3" href="{{route('home.profile.my-profile')}}">ویرایش حساب</a></span>
                            </section>
                            <section class="sidebar-nav-item">
