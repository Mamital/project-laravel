                                            ...
                                            <section class="product">
                                                ...
                                                @guest
                                                    <section class="product-add-to-favorite">
                                                        <button class="btn btn-light btn-sm text-decoration-none"
                                                            ...
                                                            data-url="{{ route('home.product.add-favorite', $mostVisitedProduct) }}"
                                                ...
                                                <a class="product-link"
                                                    ...
                                                    <section class="product-image">
                                                        <img class=""
                                                            src="{{ asset($mostVisitedProduct->image['indexArray'][$mostVisitedProduct->image['currentImage']]) }}"
                                                            alt="">
                                                    </section>
                                            ...
                                            <section class="product">
                                                ...
                                                @guest
                                                    <section class="product-add-to-favorite">
                                                        <button class="btn btn-light btn-sm text-decoration-none"
                                                            data-bs-toggle="tooltip" data-bs-placement="left"
                                                            data-url="{{ route('home.product.add-favorite', $offerProduct) }}"
                                                            title="افزودن به علاقه مندی">
                                                            <i class="fa fa-heart"></i>
                                                        </button>
                                                    </section>
                                                ...
                                                <a class="product-link"
                                                    ...
                                                    <section class="product-image">
                                                        <img class=""
                                                            src="{{ asset($offerProduct->image['indexArray'][$offerProduct->image['currentImage']]) }}"
                                                            alt="">
                                                    </section>
                                                    <section class="product-colors"></section>
                                                    <section class="product-name">
