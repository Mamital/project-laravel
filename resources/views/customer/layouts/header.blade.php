                                ...
                                <section class="header-cart-dropdown">
                                    ...
                                    <section class="header-cart-dropdown-body">
                                        ...
                                        @foreach ($cartItems as $cartItem)
                                            @php
                                                $total_price += $cartItem->cartItemFinalPrice();
                                            @endphp
                                            <section
                                                ...
                                                <section class="w-100 text-truncate"><a
                                                        ...
                                                        href="{{ route('home.product.index', $cartItem->product->slug) }}">{{ $cartItem->product->name }}</a>
                                                </section>
                                    ...
                                    <section
                                        ...
                                        <section class="">
                                            ...
                                            <section> {{ priceFormat($total_price) }}</section>
                                        </section>
                    ...
                    <section class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                        ...
                        <section class="offcanvas-header">
                            <h5 class="offcanvas-title" id="offcanvasExampleLabel"><a class="text-decoration-none"
                                    href="index.html"><img src="{{asset('customer-assets/images/logo/8.png')}}" alt="logo"></a></h5>
